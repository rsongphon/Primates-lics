...
This starts all infrastructure services that the tests validate.
...
**All tests run against services in Docker containers.** No local installation of PostgreSQL, Redis, or other services required.
