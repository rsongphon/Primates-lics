...
def upgrade() -> None:
    ...
    # ### commands auto generated by Alembic - adjusted to remove duplicates ###

    # Create devices table (NEW)
    ...
    # Create experiment_devices junction table (NEW)
    ...
    # Create experiment_tasks junction table (NEW)
    ...
    # Create task_executions table (NEW)
...
def downgrade() -> None:
    ...
    # Drop experiment_tasks junction table
    ...
    # Drop experiment_devices junction table
