"""Add created_by and updated_by columns to organizations table

Revision ID: 3d3e68596ea7
Revises: e1ec3c938dde
Create Date: 2025-10-23 06:55:35.589546
...
revision: str = "3d3e68596ea7"
down_revision: Union[str, None] = "e1ec3c938dde"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "last_maintenance_at", sa.DateTime(timezone=True), nullable=True
        ),
        sa.Column(
            "next_maintenance_at", sa.DateTime(timezone=True), nullable=True
        ),
        ...
        sa.UniqueConstraint(
            "organization_id", "name", name="uq_devices_org_name"
        ),
    )
    op.create_index(
        "idx_devices_active", "devices", ["is_active"], unique=False
    )
    op.create_index(
        "idx_devices_heartbeat", "devices", ["last_heartbeat_at"], unique=False
    )
    op.create_index(
        "idx_devices_location", "devices", ["location"], unique=False
    )
    op.create_index(
        "idx_devices_organization_status",
        "devices",
        ["organization_id", "status"],
        unique=False,
    )
    op.create_index(
        "idx_devices_type", "devices", ["device_type"], unique=False
    )
    op.create_index(
        op.f("ix_devices_mac_address"), "devices", ["mac_address"], unique=True
    )
    op.create_index(
    ...
    op.create_index(
        "idx_permissions_action", "permissions", ["action"], unique=False
    )
    op.create_index(
        "idx_permissions_resource", "permissions", ["resource"], unique=False
    )
    op.create_index(
        "idx_permissions_system",
        "permissions",
    ...
    op.create_index(
        "idx_roles_parent", "roles", ["parent_role_id"], unique=False
    )
    op.create_index(
        "idx_roles_system", "roles", ["is_system_role"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "email_verification_token", sa.String(length=512), nullable=True
        ),
        sa.Column(
            "email_verified_at", sa.DateTime(timezone=True), nullable=True
        ),
        sa.Column(
            "password_reset_token", sa.String(length=512), nullable=True
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "scheduled_start_at", sa.DateTime(timezone=True), nullable=True
        ),
        sa.Column(
            "scheduled_end_at", sa.DateTime(timezone=True), nullable=True
        ),
        sa.Column(
            "actual_start_at", sa.DateTime(timezone=True), nullable=True
        ),
        ...
        sa.Column(
            "ethics_approval_number", sa.String(length=100), nullable=True
        ),
        ...
        sa.ForeignKeyConstraint(
            ...
            ["users.id"],
            name=op.f("fk_experiments_principal_investigator_id_users"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_experiments")),
        sa.UniqueConstraint(
            "organization_id", "name", name="uq_experiments_org_name"
        ),
    )
    op.create_index(
        "idx_experiments_actual_start",
        "experiments",
        ["actual_start_at"],
        unique=False,
    )
    op.create_index(
        "idx_experiments_organization_status",
        "experiments",
        ["organization_id", "status"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_experiments_scheduled_start",
        "experiments",
        ["scheduled_start_at"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_experiments_experiment_type"),
        "experiments",
        ["experiment_type"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            ...
            "name",
            "version",
            name="uq_tasks_org_name_version",
        ),
    )
    op.create_index("idx_tasks_author", "tasks", ["author_id"], unique=False)
    op.create_index(
        "idx_tasks_organization_category",
        "tasks",
    ...
    op.create_index(
        "idx_tasks_template", "tasks", ["is_template"], unique=False
    )
    op.create_index("idx_tasks_usage", "tasks", ["usage_count"], unique=False)
    op.create_index(
        "idx_tasks_validated", "tasks", ["is_validated"], unique=False
    )
    op.create_index(
        op.f("ix_tasks_category"), "tasks", ["category"], unique=False
    )
    op.create_index(
        op.f("ix_tasks_is_public"), "tasks", ["is_public"], unique=False
    )
    op.create_index(
        op.f("ix_tasks_is_template"), "tasks", ["is_template"], unique=False
    )
    op.create_table(
        "user_roles",
        sa.Column("user_id", sa.UUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["device_id"],
            ["devices.id"],
            name=op.f("fk_experiment_devices_device_id_devices"),
        ),
        sa.ForeignKeyConstraint(
            ["experiment_id"],
            ["experiments.id"],
            name=op.f("fk_experiment_devices_experiment_id_experiments"),
        ),
        sa.PrimaryKeyConstraint(
            "experiment_id", "device_id", name=op.f("pk_experiment_devices")
        ),
    )
    op.create_index(
        "idx_experiment_devices_device_id",
        "experiment_devices",
        ["device_id"],
        unique=False,
    )
    op.create_index(
        "idx_experiment_devices_exp_id",
        "experiment_devices",
        ["experiment_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["experiment_id"],
            ["experiments.id"],
            name=op.f("fk_experiment_tasks_experiment_id_experiments"),
        ),
        sa.ForeignKeyConstraint(
            ["task_id"],
            ["tasks.id"],
            name=op.f("fk_experiment_tasks_task_id_tasks"),
        ),
        sa.PrimaryKeyConstraint(
            "experiment_id", "task_id", name=op.f("pk_experiment_tasks")
        ),
    )
    op.create_index(
        "idx_experiment_tasks_exp_id",
        "experiment_tasks",
        ["experiment_id"],
        unique=False,
    )
    op.create_index(
        "idx_experiment_tasks_order",
        "experiment_tasks",
        ["execution_order"],
        unique=False,
    )
    op.create_index(
        "idx_experiment_tasks_task_id",
        "experiment_tasks",
        ["task_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "enrollment_date", sa.DateTime(timezone=True), nullable=False
        ),
        sa.Column(
        ...
        sa.ForeignKeyConstraint(
            ["experiment_id"],
            ["experiments.id"],
            name=op.f("fk_participants_experiment_id_experiments"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_participants")),
        sa.UniqueConstraint(
            "experiment_id", "participant_id", name="uq_participants_exp_id"
        ),
    )
    op.create_index(
        "idx_participants_enrollment",
        "participants",
        ["enrollment_date"],
        unique=False,
    )
    op.create_index(
        "idx_participants_experiment",
        "participants",
        ["experiment_id"],
        unique=False,
    )
    op.create_index(
        "idx_participants_species", "participants", ["species"], unique=False
    )
    op.create_index(
        "idx_participants_status", "participants", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_participants_experiment_id"),
        "participants",
        ["experiment_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_participants_status"),
        "participants",
        ["status"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["device_id"],
            ["devices.id"],
            name=op.f("fk_task_executions_device_id_devices"),
        ),
        sa.ForeignKeyConstraint(
            ["experiment_id"],
            ["experiments.id"],
            name=op.f("fk_task_executions_experiment_id_experiments"),
        ),
        sa.ForeignKeyConstraint(
            ["task_id"],
            ["tasks.id"],
    ...
    op.create_index(
        "idx_task_executions_completed",
        "task_executions",
        ["completed_at"],
        unique=False,
    )
    op.create_index(
        "idx_task_executions_device",
        "task_executions",
        ["device_id"],
        unique=False,
    )
    op.create_index(
        "idx_task_executions_experiment",
        "task_executions",
        ["experiment_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_task_executions_device_id"),
        "task_executions",
        ["device_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_task_executions_execution_id"),
        "task_executions",
        ["execution_id"],
        unique=True,
    )
    op.create_index(
        op.f("ix_task_executions_experiment_id"),
        "task_executions",
        ["experiment_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_task_executions_task_id"),
        "task_executions",
        ["task_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["device_id"],
            ["devices.id"],
            name=op.f("fk_device_data_device_id_devices"),
        ),
        sa.ForeignKeyConstraint(
            ["task_execution_id"],
            ["task_executions.id"],
            name=op.f("fk_device_data_task_execution_id_task_executions"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_device_data")),
    )
    op.create_index(
        "idx_device_data_device_timestamp",
        "device_data",
        ["device_id", "timestamp"],
        unique=False,
    )
    op.create_index(
        "idx_device_data_numeric",
        "device_data",
        ["numeric_value"],
        unique=False,
    )
    op.create_index(
        "idx_device_data_source", "device_data", ["data_source"], unique=False
    )
    op.create_index(
        "idx_device_data_task_execution",
        "device_data",
        ["task_execution_id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_device_data_type", "device_data", ["data_type"], unique=False
    )
    op.create_index(
        op.f("ix_device_data_data_type"),
        "device_data",
        ["data_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_device_data_device_id"),
        "device_data",
        ["device_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_device_data_numeric_value"),
        "device_data",
        ["numeric_value"],
        unique=False,
    )
    op.create_index(
        op.f("ix_device_data_task_execution_id"),
        "device_data",
        ["task_execution_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_device_data_timestamp"),
        "device_data",
        ["timestamp"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["experiment_id"],
            ["experiments.id"],
            name=op.f("fk_experiment_data_experiment_id_experiments"),
        ),
        sa.ForeignKeyConstraint(
            ["participant_id"],
            ["participants.id"],
            name=op.f("fk_experiment_data_participant_id_participants"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_experiment_data")),
    )
    op.create_index(
        op.f("ix_experiment_data_experiment_id"),
        "experiment_data",
        ["experiment_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_experiment_data_participant_id"),
        "experiment_data",
        ["participant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_experiment_data_trial_type"),
        "experiment_data",
        ["trial_type"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_experiment_data_trial_type"), table_name="experiment_data"
    )
    op.drop_index(
        op.f("ix_experiment_data_participant_id"), table_name="experiment_data"
    )
    op.drop_index(
        op.f("ix_experiment_data_experiment_id"), table_name="experiment_data"
    )
    op.drop_table("experiment_data")
    op.drop_index(op.f("ix_device_data_timestamp"), table_name="device_data")
    op.drop_index(
        op.f("ix_device_data_task_execution_id"), table_name="device_data"
    )
    op.drop_index(
        op.f("ix_device_data_numeric_value"), table_name="device_data"
    )
    ...
    op.drop_index(
        op.f("ix_task_executions_task_id"), table_name="task_executions"
    )
    op.drop_index(
        op.f("ix_task_executions_status"), table_name="task_executions"
    )
    op.drop_index(
        op.f("ix_task_executions_experiment_id"), table_name="task_executions"
    )
    op.drop_index(
        op.f("ix_task_executions_execution_id"), table_name="task_executions"
    )
    op.drop_index(
        op.f("ix_task_executions_device_id"), table_name="task_executions"
    )
    ...
    op.drop_index(
        "idx_task_executions_experiment", table_name="task_executions"
    )
    op.drop_index("idx_task_executions_device", table_name="task_executions")
    op.drop_index(
        "idx_task_executions_completed", table_name="task_executions"
    )
    op.drop_table("task_executions")
    op.drop_index(op.f("ix_participants_status"), table_name="participants")
    op.drop_index(
        op.f("ix_participants_experiment_id"), table_name="participants"
    )
    ...
    op.drop_index(
        "idx_experiment_tasks_task_id", table_name="experiment_tasks"
    )
    ...
    op.drop_index(
        "idx_experiment_devices_exp_id", table_name="experiment_devices"
    )
    op.drop_index(
        "idx_experiment_devices_device_id", table_name="experiment_devices"
    )
    op.drop_table("experiment_devices")
    op.drop_index(op.f("ix_user_sessions_user_id"), table_name="user_sessions")
    op.drop_index(
        op.f("ix_user_sessions_session_token"), table_name="user_sessions"
    )
    ...
    op.drop_table("tasks")
    op.drop_index(
        "idx_role_permissions_role_id", table_name="role_permissions"
    )
    op.drop_index(
        "idx_role_permissions_permission_id", table_name="role_permissions"
    )
    ...
    op.drop_index(
        op.f("ix_refresh_tokens_token_id"), table_name="refresh_tokens"
    )
    ...
    op.drop_index(
        op.f("ix_experiments_experiment_type"), table_name="experiments"
    )
    ...
    op.drop_index(
        "idx_experiments_organization_status", table_name="experiments"
    )
    ...
    op.drop_index(
        op.f("ix_users_email_verification_token"), table_name="users"
    )
