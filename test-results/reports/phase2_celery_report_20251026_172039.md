...
- [✅] **TC-CELERY-025**: Task Monitoring API
  ...
  - Duration: 0.01s
- **Pass Rate**: 60.0% (15/25 tests passing)
...
1. **Issue ID**: TC-CELERY-001 | **Severity**: High | **Description**: Celery Worker Startup
   - Error: Health check returned 401
2. **Issue ID**: TC-CELERY-007 | **Severity**: High | **Description**: Task - Send Webhook Notification
3. **Issue ID**: TC-CELERY-009 | **Severity**: High | **Description**: Task - Generate Experiment Report
4. **Issue ID**: TC-CELERY-010 | **Severity**: High | **Description**: Task - Generate Participant Progress Report
5. **Issue ID**: TC-CELERY-011 | **Severity**: High | **Description**: Task - Export Data to Storage
6. **Issue ID**: TC-CELERY-012 | **Severity**: High | **Description**: Task - Cleanup Expired Sessions
7. **Issue ID**: TC-CELERY-013 | **Severity**: High | **Description**: Task - Refresh Cache Warmup
8. **Issue ID**: TC-CELERY-014 | **Severity**: High | **Description**: Task - Backup Database
9. **Issue ID**: TC-CELERY-021 | **Severity**: High | **Description**: Flower Monitoring UI
   - Error: Flower not accessible: Cannot connect to host localhost:5555 ssl:default [Multiple exceptions: [Errno 61] Connect call failed ('::1', 5555, 0, 0), [Errno 61] Connect call failed ('127.0.0.1', 5555)]
10. **Issue ID**: TC-CELERY-022 | **Severity**: High | **Description**: Prometheus Metrics
   - Error: Metrics endpoint returned 401
