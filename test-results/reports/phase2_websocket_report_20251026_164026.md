...
- [ ] **TC-WS-003**: Room Subscription - Device
  ...
  - **Failed Steps**: 1
    - Step 1: Subscribe to device room
      - Error: Subscription failed: AsyncClient.connect() got an unexpected keyword argument 'timeout'
...
## Sign-off
- **Test Date**: 2025-10-26 16:40:27
- **Test Duration**: 0.85s
- **Approval**: **FAIL**
- **Conditions**: 6 test(s) failed - review required

## Attachments
- [x] Test results JSON: phase2_websocket_20251026_164026.json
