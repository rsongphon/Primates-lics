...
- [ ] **TC-WS-003**: Room Subscription - Device
  ...
  - **Failed Steps**: 1
    - Step 1: Subscribe to device room
      - Error: Subscription failed: /devices is not a connected namespace.
- [ ] **TC-WS-004**: Room Subscription - Experiment
  ...
  - **Failed Steps**: 1
    - Step 1: Subscribe to experiment room
      - Error: Subscription failed: /experiments is not a connected namespace.
- [ ] **TC-WS-005**: Room Subscription - Organization
  ...
  - **Failed Steps**: 1
    - Step 1: Subscribe to organization room
      - Error: Subscription failed: /notifications is not a connected namespace.
...
1. **Issue ID**: TC-WS-003 | **Severity**: High | **Description**: Room Subscription - Device
   - Error: Subscription failed: /devices is not a connected namespace.
2. **Issue ID**: TC-WS-004 | **Severity**: High | **Description**: Room Subscription - Experiment
   - Error: Subscription failed: /experiments is not a connected namespace.
3. **Issue ID**: TC-WS-005 | **Severity**: High | **Description**: Room Subscription - Organization
   - Error: Subscription failed: /notifications is not a connected namespace.
4. **Issue ID**: TC-WS-017 | **Severity**: High | **Description**: WebSocket Reconnection
   - Error: Reconnection failed: BaseEventLoop.create_connection() got an unexpected keyword argument 'extra_headers'
5. **Issue ID**: TC-WS-019 | **Severity**: High | **Description**: Multiple Connections
   - Error: Multiple connections failed: BaseEventLoop.create_connection() got an unexpected keyword argument 'extra_headers'
6. **Issue ID**: TC-WS-020 | **Severity**: High | **Description**: WebSocket Disconnect
   - Error: Disconnect failed: BaseEventLoop.create_connection() got an unexpected keyword argument 'extra_headers'
...
## Sign-off
- **Test Date**: 2025-10-26 17:01:31
- **Test Duration**: 0.54s
- **Approval**: **FAIL**
- **Conditions**: 6 test(s) failed - review required

## Attachments
- [x] Test results JSON: phase2_websocket_20251026_170131.json
