...
- [ ] **TC-DOMAIN-002**: Device Registration
  ...
  - **Failed Steps**: 1
    - Step 1: Device registration
      - Error: Status: 400, {"error":{"code":"HTTP_ERROR","message":"DeviceRepository.__init__() takes 2 positional arguments but 3 were given","trace_id":"fcc88f9b-f92a-42ed-8c4f-c8397b52e5a3"}}
...
- [ ] **TC-DOMAIN-005**: Experiment Creation
  ...
  - **Failed Steps**: 1
    - Step 1: Experiment creation
      - Error: Status: 422, {"error":{"code":"VALIDATION_ERROR","message":"Request validation failed","details":{"validation_errors":[{"field":"body -> experiment_type","message":"Field required","type":"missing"},{"field":"body -> principal_investigator_id","message":"Field required","type":"missing"}]},"trace_id":"31ce0739-ff1b-4a0a-819c-45373c50c6da"}}
...
- [ ] **TC-DOMAIN-007**: Participant (Primate) Management
  ...
  - **Failed Steps**: 1
    - Step 1: Participant registration
      - Error: Status: 500, {"error":{"code":"INTERNAL_SERVER_ERROR","message":"An unexpected error occurred","trace_id":"a0bd315c-2ea9-4336-b9e2-0d103a29c802"}}
...
- [ ] **TC-DOMAIN-009**: Task Definition Creation
  ...
  - **Failed Steps**: 1
    - Step 1: Task definition creation
      - Error: Status: 422, {"error":{"code":"VALIDATION_ERROR","message":"Request validation failed","details":{"validation_errors":[{"field":"body -> definition","message":"Value error, Task must have an end node","type":"value_error"}]},"trace_id":"8d7b0316-7f4b-4b55-b71b-a929ccaa68a7"}}
...
## Sign-off
- **Test Date**: 2025-10-23 12:52:09
- **Test Duration**: 0.87s
- **Approval**: **FAIL**
- **Conditions**: 12 test(s) failed - review required

## Attachments
- [x] Test results JSON: phase2_domain_20251023_125207.json
